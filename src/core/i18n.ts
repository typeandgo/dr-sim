...
export const EN = {
  ...
  'guide.title': 'DR-SIM — Guide',
  'guide.pageHint': 'What DR-SIM is, how it is used, and the anatomy of a profile file. Written for first-time users; no technical background required.',
  'guide.open': 'Guide',
  'guide.openTitle': 'Open the guide in a new tab',
  'guide.toSettingsHint': 'Rules, fault type, limits and site permissions are all on the settings page.',
  'options.guide': 'What DR-SIM is and how to use it',
  'options.guideHint': 'The guide and the sample profile file live on their own page so this one stays a place for settings.',

  'guide.sample': 'Sample profile',
  'guide.sampleHint': 'A ready-made profile file. Download it, adjust the domain and rules to your own application, then load it from the panel with “⤓ Import”.',
  'guide.sampleDownload': 'Download the sample',
  'guide.sampleCopy': 'Copy',
  'guide.sampleCopied': 'Copied to the clipboard.',
  'guide.sampleScenarios': 'Ready-made scenario files are not part of the extension package. A profile file you received from your team is loaded with “⤓ Import” in the panel.',
  'guide.schema': 'Profile fields — what each key means',
  'guide.schemaHint': 'A reference for the file above. Open the group you need. Only the “rules” list is required; everything else falls back to your current settings.',
  'guide.schemaRequired': 'required',
  'guide.schemaOptional': 'optional',
...
export const TR: Record<MessageKey, string> = {
  ...
  'guide.title': 'DR-SIM — Kılavuz',
  'guide.pageHint': 'DR-SIM nedir, nasıl kullanılır ve profil dosyasının anatomisi. İlk kez kullananlar için yazıldı; teknik bilgi gerektirmez.',
  'guide.open': 'Kılavuz',
  'guide.openTitle': 'Kılavuzu yeni sekmede aç',
  'guide.toSettingsHint': 'Kurallar, arıza tipi, limitler ve site izinleri ayarlar sayfasında.',
  'options.guide': 'DR-SIM nedir, nasıl kullanılır?',
  'options.guideHint': 'Kılavuz ve örnek profil dosyası kendi sayfasında; burası ayar yapılan yer olarak kalsın diye.',

  'guide.sample': 'Örnek profil',
  'guide.sampleHint': 'Hazır bir profil dosyası. İndir, domain ve kuralları kendi uygulamana göre değiştir, sonra panelden “⤓ İçe” ile yükle.',
  'guide.sampleDownload': 'Örneği indir',
  'guide.sampleCopy': 'Kopyala',
  'guide.sampleCopied': 'Panoya kopyalandı.',
  'guide.sampleScenarios': 'Hazır senaryo dosyaları eklenti paketine dahil değildir. Ekibinden aldığın bir profil dosyasını panelden “⤓ İçe” ile yüklersin.',
  'guide.schema': 'Profil alanları — hangi anahtar ne demek',
  'guide.schemaHint': 'Yukarıdaki dosyanın sözlüğü. İhtiyacın olan grubu aç. Zorunlu olan tek alan “rules” listesidir; kalanı verilmezse mevcut ayarların geçerli kalır.',
  'guide.schemaRequired': 'zorunlu',
  'guide.schemaOptional': 'isteğe bağlı',
